...
const Index = () => {
  const contributors = [
    ...
    },
    {
      ...
      github: "kashyap1710", // Replace with actual GitHub username
      contributions: [
        "Initial repository setup",
        "Homepage design",
        "Project structure",
            ...
            {[
              {
                step: 1,
                title: "Fork & Clone",
                desc: "Fork the repository and clone to local machine",
              },
              {
                step: 2,
                title: "Create Branch",
                desc: "Create a new feature branch for your changes",
              },
              {
                step: 3,
                title: "Make Changes",
                desc: "Add your contribution and commit changes",
              },
              {
                step: 4,
                title: "Pull Request",
                desc: "Submit PR for review and merge approval",
              },
            ].map((item, index) => (
      ...
      <footer className="bg-slate-900 text-white py-12 px-4">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-slate-400">
                A demonstration project showcasing collaborative development
                workflows using modern Git practices.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-slate-800 mt-8 pt-8 text-center text-slate-500">
            <p>
              © 2024 Collaboration Demo Site. Built for educational purposes.
            </p>
          </div>
        </div>
      </footer>
